...
import { searchManagers, setManager } from './stepsActions';
...
class SelectManager extends Component {
	...
	handleSearchChange(e, { value }) {
		...
		this.props.searchManagers(value);
	}
...
function mapStateToProps(state){
    return state.app.steps.manager;
}

export default connect(mapStateToProps, { searchManagers, setManager })(SelectManager);